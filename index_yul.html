...
function init(){
   ...
   map.setCenter(new OpenLayers.LonLat(-71.8754,47.0546),10);

 var brasdunord_layer = new OpenLayers.Layer.TMS( "bras du nord",
        "http://cartalibv2.mapgears.com/mapcache/tms/",
        { layername: 'yulaire@g', type: "png", serviceVersion:"1.0.0",
